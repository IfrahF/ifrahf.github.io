...
fig2 = instacart %>%
  ...
  top_n(10)  %>%
  plot_ly(labels = ~product_name, values = ~times_ordered, type = "pie", hole = 0.6, textinfo = "label", colors = "viridis") 

fig2 %>%    
  layout(title = "Top 10 Items Added to the Cart", showlegend = F)
```
